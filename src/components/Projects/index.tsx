    ...
    <ProjectsContainer id="projects">
      <ProjectsContent>
        <div>
          ...
          <p>
            Projetos que desenvolvi durante minha jornada.
            <br />
            alguns em <TextRed>cursos</TextRed>, outros em{" "}
            <TextRed>eventos</TextRed> e alguns
            <br />
            são projetos <TextRed>pessoais</TextRed>
          </p>
          <a href="https://github.com/JonathaGomes" target="_blank">
            VEJA TODOS
          </a>
        </div>
        <div></div>
